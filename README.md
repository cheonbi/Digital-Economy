...
**Q. Jupyter Notebook 파일이 열리지 않습니다? pdf, 텍스트, 인터넷, 크롬등으로 바뀌었습니다?**

A. .ipynb로 끝나는 파일은 Jupyter Notebook 파일로 Jupyter Notebook에서만 "제대로" 열립니다.    
여러분들의 PC에서 표시되는 아이콘에 현혹되지 마시기 바랍니다.    
...
아래 이미지처럼 여러분들의 과거 행동들에 따라서 아이콘은 다양한 모습이 가능하고 다른 PC나 환경 장소에 따라 얼마든지 바뀔수 있습니다.    
인위적으로 바꿀수도 있으며 파일이 바뀐게 아니니 걱정 말고, "유형"에 IPYNB 파일 또는 확장자가 .ipynb로 끝난다면 오로지 Jupyter Notebook에서만 열립니다.    
